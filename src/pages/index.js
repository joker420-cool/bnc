...
import { Theme, Link, Button, Text, Icon, Box } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		...
		>
			<Text as="h1" font="normal 900 72px/1.2 --fontFamily-sans" md-font="--headline2" margin="10px 0">
				IT IS NOT ABOUT LIVING FOR EVER.{" "}
				<br />
				{" "}THE TRICK IS LIVING YOUR SELF FOR EVER.
			</Text>
			<Stack>
